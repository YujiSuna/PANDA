        ...
        <div id="card-cadastro" class="card">
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab">
                    <?php include '/xampp/htdocs/PANDA/src/php/includes/ferramentas/cadastros/cadastro-turma.php'; ?>
                </div>
                <div class="tab-pane" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab">
                    <?php include '/xampp/htdocs/PANDA/src/php/includes/ferramentas/cadastros/cadastro-aluno.php'; ?>
                </div>
            </div>
        </div>
    </div>
