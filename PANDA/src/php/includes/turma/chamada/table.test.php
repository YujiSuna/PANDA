<div class="row">
    <div class="col-12 d-flex justify-content-around align-items-center">
        <h1>De qual data deseja realizar chamada?</h1>
    </div>
</div>
...
<div class="div-table row">
    <form class="col-12 needs-validation" action="/PANDA/src/php/pages/turma.php" method="get" novalidate>
        ...
        <button class="btn btn-primary w-100 mt-2 col-6">Realizar Chamada</button>
    </form>
    ...
    <form class="col-12" action="/PANDA/src/php/pages/turma.php" method="get">
        ...
        <button class="btn btn-outline-primary w-100 mt-2">Realizar Chamada de HOJE</button>
    </form>
</div>
