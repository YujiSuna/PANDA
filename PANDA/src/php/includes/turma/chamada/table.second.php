...
<div class="div-table">
    ...
    <div class="d-flex justify-content-between">
        ...
        <button class="btn btn-primary w-25 mt-2 <?php echo $buttonSalvarDisplay ?>" onclick="backToCalendar()">salvar</button>
    </div>
</div>
...
<script>
    ...
    window.addEventListener("load", () => {
        ...
        <?php echo ($nivel_user == '2') ? "$('.form-check-input')[0].disabled = true;" : ''; ?>
